        ...
        if ($num > 0) {
            echo "<div class='error'>username used for another</div>";
					...
					$insert = mysqli_query($connect, "INSERT INTO users "
						    ...
						    . "VALUES "
						    . "('$loginname','$userPass1','$fullname','$phone','$address',1)"
						    . "");
...
<a href="?action=addUser" style="text-decoration:none;">
	<div align="right" style="float:center;color:white;font-size:1.0em;margin:10px;width:111px;background:green;padding:6px;border-radius:4px;">

		<span style="float:center;margin-right:10px;" >New Manager</span>
...
<table style="min-width:300px;float:center;" class="tablein" >
    ...
    <?php
    $query = mysqli_query($connect, "SELECT * FROM users WHERE 1 AND user_type=1 AND row_deleted=0");
    $row_number=0;
